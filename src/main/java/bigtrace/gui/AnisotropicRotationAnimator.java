...
public class AnisotropicRotationAnimator extends AbstractTransformAnimator
{
	...
	public AnisotropicRotationAnimator( final AffineTransform3D transformStart, final double viewerCenterX, final double viewerCenterY, final double[] targetOrientation, final long duration )
	{
		super( duration );
		...
		Affine3DHelpers.extractRotationAnisotropic( transformStart, qCurrent );
